...
<section class="section1">
          ...
          <h4 class="display-6 mb-5">List Of Designs For Evaluation</h4> 
...
<c:forEach var="evaluation" items="${listDemandes}" >
  <li> 
    <a href="<%= request.getContextPath() %>/Controller/createEval?id=${evaluation.evaluation_id}" class="card">
      ...
      <div class="card__overlay">
        <div class="card__header">
          ...
          <div class="card__header-text">
            ...
            <h3 class="card__title">${evaluation.first_name} ${evaluation.last_name}</h3>            
            <span class="card__status">${evaluation.statut}</span>
          </div>
        </div>
        <p class="card__description"> ${evaluation.comment}</p>
      </div>
    </a>      
  </li>
  </c:forEach>  
