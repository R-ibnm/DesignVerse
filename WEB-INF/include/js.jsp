    ...
    <script src="${pageContext.request.contextPath}/template/lib/wow/wow.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/template/lib/counterup/counterup.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/lib/lightbox/js/lightbox.min.js"></script>
