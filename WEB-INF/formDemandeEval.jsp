        ...
        <div class="container">
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-4 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                     ...
                     <form action="<%= request.getContextPath() %>/Controller/createDemandeEval" method="post" enctype="multipart/form-data">
                        <div class="row g-3" style="text-align:center">
                            <div class="col-12" >
                                <div class="form-floating" >                               	
                                    <input type="text" class="form-control" name="comment" placeholder="comment" >
                                    <label for="comment" >Have a little comment ?</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="file" class="form-control" name="design" placeholder="Upload picture">
                                    <label for="path">Upload Your Design</label>
                                </div>
                            </div>
